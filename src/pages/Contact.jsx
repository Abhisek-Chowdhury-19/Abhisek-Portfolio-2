...
function Contact() {
  return (
    ...
    Let's Connect<span className="text-cyan-500">.</span><br />
   
    </h2>
    <h2 className="text-3xl mt-3 dark:text-white">
    <span className="text-cyan-500">{'{'}</span> Social Media <span className="text-cyan-500">{'}'}</span>
    </h2>
    ...
    <div className="hero-img w-2/5 flex flex-col dark:text-white max-lg:w-full">
...
<div class="grid md:grid-cols-2 md:gap-6 ">
  ...
  <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-transparent rounded-lg border border-gray-300 focus:outline-none focus:border-blue-500  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a Message..."></textarea>
